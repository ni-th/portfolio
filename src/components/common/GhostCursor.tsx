...
const GhostCursor: React.FC<GhostCursorProps> = ({
  ...
  }, [trailLength, inertia, grainIntensity, bloomStrength, bloomRadius, bloomThreshold, pixelBudget, fadeDelay, fadeDuration, isTouch, color, brightness, edgeIntensity, baseVertexShader, fragmentShader, FilmGrainShader, UnpremultiplyPass, mixBlendMode, maxDevicePixelRatio]);
